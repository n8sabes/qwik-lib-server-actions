/**
 * @license
 * @builder.io/qwik/cli 0.16.1-dev20230103235705
...
var require_onetime = __commonJS({
  "node_modules/.pnpm/onetime@5.1.2/node_modules/onetime/index.js"(exports, module2) {
    ...
    module2.exports = onetime3;
    module2.exports.default = onetime3;
...
var main = {
  info: kleur_default.blue("\u2139"),
  success: kleur_default.green("\u2714"),
  warning: kleur_default.yellow("\u26A0"),
  error: kleur_default.red("\u2716")
};
var fallback = {
  info: kleur_default.blue("i"),
  success: kleur_default.green("\u221A"),
  warning: kleur_default.yellow("\u203C"),
  error: kleur_default.red("\xD7")
};
...
var Ora = class {
  ...
  frame() {
    ...
    if (this.color) {
      frame = kleur_default[this.color](frame);
    }
...
async function logUpdateAppResult(pkgManager, result) {
  ...
  const commitAnswer = await (0, import_prompts.default)(
    {
      type: "select",
      name: "commit",
...
function npmRunPath(options = {}) {
  const {
    ...
    path: path_ = import_node_process6.default.env[pathKey()],
...
function printVersion() {
  console.log("0.16.1-dev20230103235705");
}
